...
- [Сдача проектной работы 11 спринта](#сдача-проектной-работы-11-спринта)
- [Задания](#задания)
  - [Задание 1. Модульная инфраструктура для нескольких сред](#задание-1-модульная-инфраструктура-для-нескольких-сред)
  - [Задание 2. Интеграция с CI/CD и удалённым хранением состояния](#задание-2-интеграция-с-cicd-и-удалённым-хранением-состояния)
  - [Задание 3. Проектирование целевой архитектуры и оценка рисков внедрения](#задание-3-проектирование-целевой-архитектуры-и-оценка-рисков-внедрения)
  - [Задание 4. Моделирование домена и интеграций](#задание-4-моделирование-домена-и-интеграций)
  - [Задание 5. Проектирование технологического стека и расчёт стоимости](#задание-5-проектирование-технологического-стека-и-расчёт-стоимости)
- [Что нужно сделать](#что-нужно-сделать)
  - [Лендскейп компании](#лендскейп-компании)
  - [Цели бизнеса](#цели-бизнеса)
    - [Промежуточное состояние (через пару месяцев)](#промежуточное-состояние-через-пару-месяцев)
    - [Финальное состояние (через год)](#финальное-состояние-через-год)
    - [Долгосрочная цель (горизонт три года)](#долгосрочная-цель-горизонт-три-года)
  - [Этапы трансформации](#этапы-трансформации)
